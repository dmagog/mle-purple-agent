...
<table>
  <tr>
    <td align="center">
      ...
      <sub>For scale, 0.82 is around the top 6% of the current Spaceship Titanic leaderboard &mdash; genuinely strong, though the headline is the autonomy, not the rank.</sub><br/><br/>
